...
**Note**: To discover NEW patterns, see `record-pattern` skill. For stuckness detection, see `break-pattern` skill. The catalog above is hand-maintained — adding a new pattern requires appending an entry to this list. Automating this is tracked in issue #403 (full analysis: `docs/handoffs/HANDOFF-pattern-library-static-vs-dynamic-catalog-2026-05-15-1100.md`).
