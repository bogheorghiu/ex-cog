...
Used by optional claude-memory-mcp server.

**Source:** https://github.com/anthropics/mcp
**License:** MIT

## claude-memory-mcp (Optional)

Memory system for opus-distillatus agent.

**License:** MIT
**Note:** Included in `optional/` for convenience but can be obtained separately.
